...
let i=1;
 ...
 while(j<1000){
     ...
     (new AssetService()).createPatient("rana",result.firstName,result.lastName,result.age,result.gender,result.bloodType,result.dob,result.dod,result.phoneNumber,result.address);
     ++j;
 }
}
main()